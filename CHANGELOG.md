...
## [9.0.0](https://github.com/ueaner/LazyVim/compare/v8.0.0...v9.0.0) (2023-10-01)
...
* **null-ls:** use none-ls instead of null-ls ([#1517](https://github.com/ueaner/LazyVim/issues/1517))
...
* **treesitter:** rename help to vimdoc ([#521](https://github.com/ueaner/LazyVim/issues/521))

### Features

* add a keybind to search register ([#1170](https://github.com/ueaner/LazyVim/issues/1170)) ([fc50c05](https://github.com/ueaner/LazyVim/commit/fc50c055c3db561043e23b53afc270de2231fbb2))
* added `leader-L` to show the LazyVim changelog ([9387ab3](https://github.com/ueaner/LazyVim/commit/9387ab388ec43cae0689405fcb21bb4ecf67322c))
* added extra for dap ([bc14e02](https://github.com/ueaner/LazyVim/commit/bc14e02a1ff43f1a69d2a6755faeec8a5ec26ac9))
* added extra for edgy.nvim ([56f092f](https://github.com/ueaner/LazyVim/commit/56f092f1a8f37036253a5c1f1253d0eebac6dd61))
* added extra for flash.nvim ([318a4c8](https://github.com/ueaner/LazyVim/commit/318a4c8304091422dfdfcec44dae7a676d999ee1))
* added extra for mini.hipatterns with tailwind support ([7bc979a](https://github.com/ueaner/LazyVim/commit/7bc979a7c1eacba16b60c324ae7bfab57b73a702))
* added support for the new builtin inlay hints ([01c7eee](https://github.com/ueaner/LazyVim/commit/01c7eeebd0641bd952e3c518dd28b178aed8e148))
* **autocmds:** add auto create dir ([#493](https://github.com/ueaner/LazyVim/issues/493)) ([ed48b85](https://github.com/ueaner/LazyVim/commit/ed48b85dbea30a15518b4caa58cbf5d2b54f97a0))
* **autocmds:** add checkhealth filetype to close_with_q list ([#512](https://github.com/ueaner/LazyVim/issues/512)) ([1defd5f](https://github.com/ueaner/LazyVim/commit/1defd5f67008c695a7d99d72bc50432de5eaed3a))
* **autocmds:** close InspectTree window with q ([e54d0dd](https://github.com/ueaner/LazyVim/commit/e54d0dde623c206c4f7ed9a512785c9fc0de3a22))
* **bufferline:** use `mini.bufremove` to close a buffer ([#670](https://github.com/ueaner/LazyVim/issues/670)) ([3e46dd6](https://github.com/ueaner/LazyVim/commit/3e46dd61cdc79bbb915f81e4188fc5337cd2f84b))
* **catppuccin:** enable mason integration ([#1048](https://github.com/ueaner/LazyVim/issues/1048)) ([27eb461](https://github.com/ueaner/LazyVim/commit/27eb4610bd0ffd48243f793054c7c9ab5ba08cb1))
* **catppuccin:** enabled integration for plugins included with LazyVim ([0c05f8a](https://github.com/ueaner/LazyVim/commit/0c05f8a185e61cc67199bf4b0b3b61933d292b0f))
* **catppuccin:** match navic bg with lualine ([#1085](https://github.com/ueaner/LazyVim/issues/1085)) ([67d1cbf](https://github.com/ueaner/LazyVim/commit/67d1cbfb01e84083649027a4b6356401f74d2d60))
* **clangd:** better clangd root detection ([#1165](https://github.com/ueaner/LazyVim/issues/1165)) ([d71ebea](https://github.com/ueaner/LazyVim/commit/d71ebeab24565bb109adc68253c2da6614eb5dda))
* **clangd:** remove CMakelists root_dir search ([#1230](https://github.com/ueaner/LazyVim/issues/1230)) ([9264c54](https://github.com/ueaner/LazyVim/commit/9264c54ae96d1d56f029ad9b561326c7b991c53b))
* **copilot:** added lualine component for copilot. Simple icon colored by status. Will add status message when available (warnings) ([d63c471](https://github.com/ueaner/LazyVim/commit/d63c4710083cd2bcab104972bd4a6b3d1b80c3c6))
* **copilot:** better copilot status colors for lualine ([1274310](https://github.com/ueaner/LazyVim/commit/1274310e6da0de56da92ae8e26c8f388cf314a5b))
* **copilot:** enable copilot in markdown and help files ([b929413](https://github.com/ueaner/LazyVim/commit/b929413ddd9afd64e12f0a6ec2969e3692284795))
* **dap:** add more keybindings and lualine component ([#612](https://github.com/ueaner/LazyVim/issues/612)) ([38ad79d](https://github.com/ueaner/LazyVim/commit/38ad79d5485c083afdb04b1fb9f9683403a6d7bd))
* **dap:** add step out, rebind step over ([#605](https://github.com/ueaner/LazyVim/issues/605)) ([cfaf3b0](https://github.com/ueaner/LazyVim/commit/cfaf3b054e1a68ea0f7a73d51a0f6c27395198e9))
* **dap:** added extra for dap nlua ([f562d1d](https://github.com/ueaner/LazyVim/commit/f562d1d19761c3419380c3b175fd00a440ff0932))
* **dap:** Change DAP REPL binding from open to toggle ([#663](https://github.com/ueaner/LazyVim/issues/663)) ([3a718c5](https://github.com/ueaner/LazyVim/commit/3a718c5c85e966e2751dade0006dcbeed72e8b00))
* **diagnostics:** added support for setting prefix = "icons". Check the docs on how to enable ([01a1b8e](https://github.com/ueaner/LazyVim/commit/01a1b8e80db55963f281cf36674cf1c174e2f50e))
* **diagnostics:** show diagnostics source when more than one source is reporting diagnostics ([06c38c5](https://github.com/ueaner/LazyVim/commit/06c38c52a91bb1dcc2dec2d79d6e13606324be77))
* **edgy:** added `&lt;leader&gt;ue` to quickly jump to an edgy window ([0731f08](https://github.com/ueaner/LazyVim/commit/0731f08ee43138b61eaf02ac00110babf61be99d))
* **edgy:** added LazyVim resize keymaps to edgy ([ba49339](https://github.com/ueaner/LazyVim/commit/ba49339fe314ec193ccd494be80818d7ebc5a3bd))
* **edgy:** added leader-ue to toggle edgy sidebars ([04f17cb](https://github.com/ueaner/LazyVim/commit/04f17cb86b7794fe74894e67bd09dafc0bc440d0))
* **edgy:** added noice ([47edc89](https://github.com/ueaner/LazyVim/commit/47edc8918a8754ddd3008c106ebda87f2847373e))
* **edgy:** added support for neotest ([84986b3](https://github.com/ueaner/LazyVim/commit/84986b37291c4c0874a6012ff9927d274bdaad0e))
* **edgy:** neo-tree filessystem is now also a pinned view ([6ffc895](https://github.com/ueaner/LazyVim/commit/6ffc89512e998f01b3dc1856a689de6ffdec0b9e))
* **elixir:** Add credo if none-ls is used ([#1546](https://github.com/ueaner/LazyVim/issues/1546)) ([2ffd629](https://github.com/ueaner/LazyVim/commit/2ffd629cc7a68e6e4a721ac8babe6b7cf612868e))
* Enable flash.nvim highlight on catppuccin integration ([#1206](https://github.com/ueaner/LazyVim/issues/1206)) ([76d33bb](https://github.com/ueaner/LazyVim/commit/76d33bba2cc8bd691979ee8bc66f8ac36236c3ba))
* **extra:** Add Elixir support and config ([#993](https://github.com/ueaner/LazyVim/issues/993)) ([3d0de23](https://github.com/ueaner/LazyVim/commit/3d0de235eca0ea6987947e4a7c47f1393e42dfb2))
* **extra:** add yaml language extension ([#1198](https://github.com/ueaner/LazyVim/issues/1198)) ([6dc6685](https://github.com/ueaner/LazyVim/commit/6dc66852b8851f02b372e8a2882fddf04b3b6966))
* **extras:** add ruby as extras for languages ([#881](https://github.com/ueaner/LazyVim/issues/881)) ([b37616c](https://github.com/ueaner/LazyVim/commit/b37616c20385520c2a06faca1a2f8954b015af5d))
* **extras:** add terraform extra ([#1030](https://github.com/ueaner/LazyVim/issues/1030)) ([0db31c2](https://github.com/ueaner/LazyVim/commit/0db31c2840af662c856d5b9a09d87bc266e7fa40))
* **extras:** added `conform.nvim` extra you can use instead of null-ls/none-ls ([f61a243](https://github.com/ueaner/LazyVim/commit/f61a243d1aca582963aca3f2c2c7c2ae0be16b06))
* **extras:** added extra for mini.files ([e624511](https://github.com/ueaner/LazyVim/commit/e624511fa249bc3af58e61b0ee5fdd4426bc2977))
* **extras:** added extra for nvim-lint ([05f45bb](https://github.com/ueaner/LazyVim/commit/05f45bb7200a6fd33ab7366553b957fa222e2cdf))
* **extras:** added extra for tailwindcss ([3f5c2c2](https://github.com/ueaner/LazyVim/commit/3f5c2c283e30f7b4c4c290d7a731e7dfbc86d8b8))
* **extras:** added project management ([#300](https://github.com/ueaner/LazyVim/issues/300)) ([7fe0d5c](https://github.com/ueaner/LazyVim/commit/7fe0d5c7c798e2a1d6abf7d43380876a268ac462))
* **extras:** added simple csharp extra ([afdcec5](https://github.com/ueaner/LazyVim/commit/afdcec5b4adccd94ff64774340a3ffd33a9d4ecf))
* **extras:** added yanky extra (yank-ring) ([a1820c1](https://github.com/ueaner/LazyVim/commit/a1820c1b428fc7f72fc31ea8465260b1816349ab))
* **flash:** add treesitter to normal mode as well ([aa28119](https://github.com/ueaner/LazyVim/commit/aa28119aa6526d26920da25c35e83d856a8584fb))
* **flash:** added remote flash ([c3477ed](https://github.com/ueaner/LazyVim/commit/c3477ed81e8e26bce1eb53f9c04a8aa7adc1807a))
* **flash:** added treesiter search to show ts node labels around search matches ([5e6a072](https://github.com/ueaner/LazyVim/commit/5e6a07200c0cc0a21167a341c1f29bf27dc35f02))
* **flash:** enable flash in vscode ([f6f8436](https://github.com/ueaner/LazyVim/commit/f6f8436fe8696a8934a28a1fd21bf28409fee7ab))
* **flash:** Make flash.nvim the default jump plugin for LazyVim ([ae759b9](https://github.com/ueaner/LazyVim/commit/ae759b947b1ef16d9814fcddfcafe2cdd767bc6a))
* **flash:** telescope integration. Use `s` in normal and `&lt;c-s&gt;` in insert mode ([12b5723](https://github.com/ueaner/LazyVim/commit/12b57235a9f8dd15914d0b2133817259e80d63a1))
* **flash:** use c-s in the cmdline to toggle flash ([22c9477](https://github.com/ueaner/LazyVim/commit/22c9477b9642b1a8abc303ffcb44c6989c7a5ca2))
* **go:** add fine-tuned LSP options, add some null-ls sources ([#1024](https://github.com/ueaner/LazyVim/issues/1024)) ([4ba5086](https://github.com/ueaner/LazyVim/commit/4ba5086b3d9f9690e8fd7d93102db66173b02638))
* **go:** add go lang extras ([#795](https://github.com/ueaner/LazyVim/issues/795)) ([163a4f9](https://github.com/ueaner/LazyVim/commit/163a4f927514ad6ea1aa06db2ad754fb954d87f5))
* **go:** add workaround to get semantic token highlighting ([#815](https://github.com/ueaner/LazyVim/issues/815)) ([2b5ae7b](https://github.com/ueaner/LazyVim/commit/2b5ae7b63c8233bbb11a922c852b8adeacd94b86))
* **hipatterns:** better tailwind fg colors ([c526ea3](https://github.com/ueaner/LazyVim/commit/c526ea338b415a51fa78936b7044ec67d78528b2))
* **hipatterns:** made tailwind ft and style configurable ([f7a6304](https://github.com/ueaner/LazyVim/commit/f7a63042f9b6f2353d861ba4cec23789d0254b5b))
* **java:** add test and debug support for Java extension ([#1192](https://github.com/ueaner/LazyVim/issues/1192)) ([f6d646a](https://github.com/ueaner/LazyVim/commit/f6d646a3251efb39f7cb5de38b529c5dd1324f28))
* **java:** support vscode launch json in Java ([#1422](https://github.com/ueaner/LazyVim/issues/1422)) ([5dc4ce3](https://github.com/ueaner/LazyVim/commit/5dc4ce3e4a452438838c271330df156fd3640c60))
* **keymaps:** added `&lt;c-/&gt;` in normal/terminal mode to toggle main terminal ([7a36e29](https://github.com/ueaner/LazyVim/commit/7a36e2989c3d62e8dbaf4036f5c4551929c565a5))
* **keymaps:** added leader-K to run keywordprg ([a28acf0](https://github.com/ueaner/LazyVim/commit/a28acf0ce7d00af11e7268c9edff579bd06abf56))
* **keymaps:** added some useful keymaps for terminals ([49ae234](https://github.com/ueaner/LazyVim/commit/49ae2344a18f93c5b4209357e265a2732365ab19))
* **keymaps:** Get rename command from inc_rename configuration ([#579](https://github.com/ueaner/LazyVim/issues/579)) ([a099b2d](https://github.com/ueaner/LazyVim/commit/a099b2d3ab3ff3bafb075c101e2b2a48b44fe869))
* **lang:** add C/C++ support ([#1025](https://github.com/ueaner/LazyVim/issues/1025)) ([e5200e6](https://github.com/ueaner/LazyVim/commit/e5200e6358766f2ba71eb229cb335c4c811902bb))
* **lang:** add cmake support ([#1032](https://github.com/ueaner/LazyVim/issues/1032)) ([fa898b7](https://github.com/ueaner/LazyVim/commit/fa898b7293c6c67b0ae2bae1d3be70413bcadd8d))
* **lang:** add debug adapter plugin for go ([#1115](https://github.com/ueaner/LazyVim/issues/1115)) ([02d673d](https://github.com/ueaner/LazyVim/commit/02d673d37c6a097a43db877644e20db84f0880b1))
* **lang:** add docker support ([#1078](https://github.com/ueaner/LazyVim/issues/1078)) ([a0c2014](https://github.com/ueaner/LazyVim/commit/a0c2014b1045243d216b244235c6a545e92471a9))
* **lang:** add java ([#1132](https://github.com/ueaner/LazyVim/issues/1132)) ([0411baa](https://github.com/ueaner/LazyVim/commit/0411baab8985450a15a54a46c48197b704bc24cc))
* **lang:** add null-ls tools to mason's ensure_installed ([#1133](https://github.com/ueaner/LazyVim/issues/1133)) ([63e8985](https://github.com/ueaner/LazyVim/commit/63e898599a00d8b1832de650ed67f63a44bf22e0))
* **lang:** add python support ([#1031](https://github.com/ueaner/LazyVim/issues/1031)) ([44cdb5e](https://github.com/ueaner/LazyVim/commit/44cdb5eac556733db53afeebcdc6ef91408de0c3))
* **lang:** Add Rust config ([#1012](https://github.com/ueaner/LazyVim/issues/1012)) ([5a441f8](https://github.com/ueaner/LazyVim/commit/5a441f897247b130c1ffb78bb37fd3a16d2250de))
* **lang:** add tex support ([#1156](https://github.com/ueaner/LazyVim/issues/1156)) ([abaa6d9](https://github.com/ueaner/LazyVim/commit/abaa6d90e4fe2c658b869e81a140a74f624d9299))
* **lsp:** add 'reuse_win' for reuse window in lsp definition keymap ([#1131](https://github.com/ueaner/LazyVim/issues/1131)) ([1b0b6eb](https://github.com/ueaner/LazyVim/commit/1b0b6eb0e13018196f0110b06149f00f2df5162f))
* **lsp:** added `nvim-lspconfig.opts.format_notify`. Enable this to debug formatter issues. ([5eccaeb](https://github.com/ueaner/LazyVim/commit/5eccaeb992217d47f111c78a3d519aae3d9a5edc))
* **lsp:** added keymap to see source actions with `&lt;leader&gt;cA` (useful for tsserver and others) ([9f5a0f1](https://github.com/ueaner/LazyVim/commit/9f5a0f1bd847663deea9cb48a178b85d7bdb3ec6))
* **lsp:** added support for setting global lsp client capabilities ([ac10516](https://github.com/ueaner/LazyVim/commit/ac1051686bcff8377f1d99228bcbe64530ec384a))
* **lsp:** added support for upcoming dynamic registration of formatters ([962fc6b](https://github.com/ueaner/LazyVim/commit/962fc6bab43cdf68e5602fe06a54c7a5fac053b6))
* **lsp:** added support to lsp keymaps for dynamic capabilities ([d0bc8b7](https://github.com/ueaner/LazyVim/commit/d0bc8b7dcea44b7bc46580ce21001c4509d046c3))
* **lsp:** automatically resolve denols/tsserver conflicts if both are configured ([d565684](https://github.com/ueaner/LazyVim/commit/d565684ade6e04eb77319ddb5becac9c5bd21cc4))
* **lsp:** custom lsp keymaps ([61e3ce8](https://github.com/ueaner/LazyVim/commit/61e3ce8cdc1159d59e11d92478ca76ea19e44c2a))
* **lsp:** make lsp work when mason-lspconfig is disabled. Fixed [#445](https://github.com/ueaner/LazyVim/issues/445) ([c10e550](https://github.com/ueaner/LazyVim/commit/c10e550639caef68146d122d9bc4a66f2f38650a))
* **lualine:** added lazy extension ([79fe045](https://github.com/ueaner/LazyVim/commit/79fe0455a02b791eae26e9934fdbaf075d9522ae))
* **mason:** compatibility with the new mason registry ([df5cbfd](https://github.com/ueaner/LazyVim/commit/df5cbfdbeccfa37ee391be8b49da7a4a4b6dcc40))
* **mini-pairs:** add toggle mini pairs keymap and function ([#1456](https://github.com/ueaner/LazyVim/issues/1456)) ([a7f971f](https://github.com/ueaner/LazyVim/commit/a7f971f30ec89473482db4ab820d2afb25fa6abf))
* **mini-starter:** add Session restore to starter menu ([#421](https://github.com/ueaner/LazyVim/issues/421)) ([bcdcfab](https://github.com/ueaner/LazyVim/commit/bcdcfab020308a90c8cb347cf63d318f4cb05941))
* **mini.ai:** decouple mini.ai from which-key. Closes [#1076](https://github.com/ueaner/LazyVim/issues/1076) ([e212c16](https://github.com/ueaner/LazyVim/commit/e212c166b4ce91bbd65a9f7fda17403ee91ed19c))
* **mini.comment:** added ts-context-commentstring back and made it work with mini.comment ([89db015](https://github.com/ueaner/LazyVim/commit/89db0157b1621deffc83a4e00cb2be13e2827a5d))
* **mini.comment:** removed ts-context-commentstring since mini.comment provides this functionality out of the box ([d41ef05](https://github.com/ueaner/LazyVim/commit/d41ef05cc00bf3502fb55512c265a02116127ca8))
* **mini.files:** "g." to toggle hidden files ([#964](https://github.com/ueaner/LazyVim/issues/964)) ([a080bc7](https://github.com/ueaner/LazyVim/commit/a080bc7667b6fadc175d782469b063fcf09b00ae))
* **mini.files:** added extra keymap to open mini.files in the cwd ([5299522](https://github.com/ueaner/LazyVim/commit/52995227808371a537f6d42ad2f0656571b92299))
* **neo-tree:** added support for LSP renaming to NeoTree ([9762e7e](https://github.com/ueaner/LazyVim/commit/9762e7e43110013a0931b8470be2929b54b4b641))
* **neo-tree:** enabled document_symbols for neo-tree ([419086e](https://github.com/ueaner/LazyVim/commit/419086e8a393df05ae1311e7580e034051df85eb))
* **neo-tree:** refresh neotree git status when closing a lazygit terminal ([ad214af](https://github.com/ueaner/LazyVim/commit/ad214af54d47e67aa8be46ae12cbe7c71da0c0bf))
* **neo-tree:** update to v3.x and change `follow_current_file` to a … ([#1143](https://github.com/ueaner/LazyVim/issues/1143)) ([69bb891](https://github.com/ueaner/LazyVim/commit/69bb89184f9297f1377f77a8b6bee2487df6ac00))
* **neotest:** added `&lt;leader&gt;tt` and `<leader>tT` to run tests in file or all test files ([efc72b0](https://github.com/ueaner/LazyVim/commit/efc72b06496f7540085928094808e9a0f45222b9))
* **neotest:** allow adapter names as a list ([98e2ffc](https://github.com/ueaner/LazyVim/commit/98e2ffcf14bb5f336ee2e4679d2b7d5699486bcc))
* **noetest:** open trouble instead of quickfix on errors when available ([2c89770](https://github.com/ueaner/LazyVim/commit/2c897705049cb89d6cd28b59be4bd7db872ffe6b))
* **noice:** added keymap to dismiss all noice messages ([0155de0](https://github.com/ueaner/LazyVim/commit/0155de00ab76e7ffc1d8232c10121f24c4e84cd9))
* **noice:** enable the inc_rename preset when inc_rename is availble ([a43d1b7](https://github.com/ueaner/LazyVim/commit/a43d1b79f29deecc694bd409ab497f8a62091b11))
* **noice:** route some undo messages to the mini view ([fc236b3](https://github.com/ueaner/LazyVim/commit/fc236b3a2a90001df11ed4a6bad7bce87f459cf9))
* **noice:** send written notifications to the mini view instead of notify ([2525b91](https://github.com/ueaner/LazyVim/commit/2525b913139c6ca288677126d1451b9683bbac1f))
* **noice:** use noice's improved entry doc view for cmp ([a213da4](https://github.com/ueaner/LazyVim/commit/a213da4430c1012bf7278080cbdc03a236e8230f))
* **null-ls:** use none-ls instead of null-ls ([#1517](https://github.com/ueaner/LazyVim/issues/1517)) ([7cac6f0](https://github.com/ueaner/LazyVim/commit/7cac6f064c5b30f6b0ae4dffab62100aa6fe2568))
* **options:** set default localleader to \ ([258f339](https://github.com/ueaner/LazyVim/commit/258f339bcf8197ece54d66bf6ed6f351cb6e98cb))
* **plugins:** automatically handle plugin repo renames ([59f3b3e](https://github.com/ueaner/LazyVim/commit/59f3b3e096280629a459054bc5538c058854dffc))
* **project:** add to mini.starter ([#640](https://github.com/ueaner/LazyVim/issues/640)) ([f898233](https://github.com/ueaner/LazyVim/commit/f8982332be70499b74623f6ed44c1c58217eb546))
* **python:** add more venv names ([#1381](https://github.com/ueaner/LazyVim/issues/1381)) ([377c0e3](https://github.com/ueaner/LazyVim/commit/377c0e397c3585cf7bae6afb8bd279a47954be0a))
* **python:** add semantic highlighting ([#1149](https://github.com/ueaner/LazyVim/issues/1149)) ([012ca50](https://github.com/ueaner/LazyVim/commit/012ca50b2801cc1c4e5b886cc26ebe0da532e31d))
* replace Copilot icon with logo ([#1539](https://github.com/ueaner/LazyVim/issues/1539)) ([9bb4e87](https://github.com/ueaner/LazyVim/commit/9bb4e8755f5a822659ca1d8cb3689732435d90d0))
* **rust:** make mason optional ([272f6af](https://github.com/ueaner/LazyVim/commit/272f6af842eb66b6e6cbdea211b17a1196acdff5))
* **rust:** make taplo configurable ([eaa0118](https://github.com/ueaner/LazyVim/commit/eaa0118dd2c91911f1457ea31b976a7c8f93164a))
* **rust:** refactor to allow easy user customization and keymaps ([a46d476](https://github.com/ueaner/LazyVim/commit/a46d47653e092f7689203ee39c9f964b1bd2d5f4))
* **rust:** rust improvements ([#1015](https://github.com/ueaner/LazyVim/issues/1015)) ([79b1c92](https://github.com/ueaner/LazyVim/commit/79b1c92dd22020b2a5ed1dbd6e6bb86242207785))
* show error and exit Neovim when version is too old ([2aea5c7](https://github.com/ueaner/LazyVim/commit/2aea5c7210882a2f98526ee29115fe2e1a41d7b4))
* **tailwind:** don't enable tailwind in markdown files ([2955445](https://github.com/ueaner/LazyVim/commit/29554455aa3e7d76377080869f0556389a05e321))
* **telescope:** add document/workspace diagnostics and todo/fixme telescope keymaps ([#557](https://github.com/ueaner/LazyVim/issues/557)) ([98775f5](https://github.com/ueaner/LazyVim/commit/98775f56312110c640be7e9d43ecc766a116427a))
* **telescope:** added `&lt;a-c&gt;` mapping for telescope pickers to switch to cwd instead of root ([c737f2b](https://github.com/ueaner/LazyVim/commit/c737f2b6c265d2c82cebf9f999425a2bd008e692))
* **telescope:** added keymap for recent files in the current directory. ([#669](https://github.com/ueaner/LazyVim/issues/669)) ([6c334fe](https://github.com/ueaner/LazyVim/commit/6c334fed6a59f6b1dc3a38f6253f2b4265557f30))
* **telescope:** allow word and selection searches ([#1096](https://github.com/ueaner/LazyVim/issues/1096)) ([6b2c648](https://github.com/ueaner/LazyVim/commit/6b2c648878b8df538d719c06394bc430cc3ed48c))
* **telescope:** use the new dynamic workspace symbols ([#577](https://github.com/ueaner/LazyVim/issues/577)) ([6e01e85](https://github.com/ueaner/LazyVim/commit/6e01e8560e4ca197bc56666e9b969fe75d91b310))
* **test:** added easy way to configure adapters ([7443eff](https://github.com/ueaner/LazyVim/commit/7443effe269ad3b2d491f43439b48f1d072c9210))
* **tests:** added neotest ([#642](https://github.com/ueaner/LazyVim/issues/642)) ([bb0d4d4](https://github.com/ueaner/LazyVim/commit/bb0d4d4e7d2e0914cb2188cab7748d70b2ae5fa8))
* **treesitter:** add jsdoc to ensure_installed ([#1252](https://github.com/ueaner/LazyVim/issues/1252)) ([566049a](https://github.com/ueaner/LazyVim/commit/566049aa4a26a86219dd1ad1624f9a1bf18831b6))
* **treesitter:** add luadoc ([#469](https://github.com/ueaner/LazyVim/issues/469)) ([ade4342](https://github.com/ueaner/LazyVim/commit/ade4342c42c47f4eadae3e6267ac35f546692158))
* **treesitter:** allow run TSUpdateSync from command line ([#944](https://github.com/ueaner/LazyVim/issues/944)) ([6b1efe7](https://github.com/ueaner/LazyVim/commit/6b1efe78e2b7fd5c40850d771c339bebae39ee49))
* **treesitter:** use Python indents as they've improved greatly ([#490](https://github.com/ueaner/LazyVim/issues/490)) ([59eb198](https://github.com/ueaner/LazyVim/commit/59eb19835f3b291912d46e5e8ea762367201cbf1))
* **tsserver:** set some tsserver formatting settings to their Neovim equivalents. Also used for organize imports ([eb92903](https://github.com/ueaner/LazyVim/commit/eb92903342a7ac12185c62bb63b5caa4c80ce7dc))
* **typescript:** added dap config for typescript. Will only be enabled when dap is also enabled ([e9fb81e](https://github.com/ueaner/LazyVim/commit/e9fb81e94d7f461b63994e3111d5c17fc84dec80))
* **util:** added util.on_load to execute code when a plugin loads ([9fd8970](https://github.com/ueaner/LazyVim/commit/9fd89701da8bd3a5d9ffeae84fb2174a3f650797))
* **util:** LazyVim terminals are now persistent by default (toggleterm) ([5a47492](https://github.com/ueaner/LazyVim/commit/5a4749253501569ec0ae2c644ed778e45ad637c0))
* **util:** LazyVim terminals can now be opened/reopened with a count ([41f515c](https://github.com/ueaner/LazyVim/commit/41f515caae653b91a93f24f4811ebeccf3457766))
* **vscode:** add `vscode=true` to any plugin spec you want to activate in vscode ([39fa636](https://github.com/ueaner/LazyVim/commit/39fa63646d14665861558c4ee7704ef51eb1b7f6))
* **vscode:** added vscode extra with minimal functionality. Will only do something when vim.g.vscode is set ([c12835a](https://github.com/ueaner/LazyVim/commit/c12835ab8683c68116503a1aab614e0d6ff68528))
* **vscode:** better vscode support ([5bf45e3](https://github.com/ueaner/LazyVim/commit/5bf45e3139aa3a8cf8e1bf9fd2a2d422fe1c6cf7))
* **vscode:** easier way to enable/disable plugins ([ae054ec](https://github.com/ueaner/LazyVim/commit/ae054ec13c987ff5ce39cfc88917f8243abae72e))
* **which-key:** easier integration for which-key group names ([df94a04](https://github.com/ueaner/LazyVim/commit/df94a044ec656c456067b550531a62e80a5be420))


### Bug Fixes

* [#1194](https://github.com/ueaner/LazyVim/issues/1194) use cmakelang instead of cmakelint ([#1197](https://github.com/ueaner/LazyVim/issues/1197)) ([b97ccb9](https://github.com/ueaner/LazyVim/commit/b97ccb9e7390b6e73e3f1a4d63a443f6cec67f07))
* [#1305](https://github.com/ueaner/LazyVim/issues/1305) rust debugging not working on windows due to missing liblldb path ([#1390](https://github.com/ueaner/LazyVim/issues/1390)) ([6045a52](https://github.com/ueaner/LazyVim/commit/6045a52d82ba4b0dcd0b050688302a22c2fc3991))
* **alpha:** use `AlphaFooter` highlight for footer section ([#461](https://github.com/ueaner/LazyVim/issues/461)) ([a7b25e1](https://github.com/ueaner/LazyVim/commit/a7b25e13fa645dea848047e0dda54db9b254ec8e))
* always lazy load keymaps. fixes [#1485](https://github.com/ueaner/LazyVim/issues/1485) ([f892ba5](https://github.com/ueaner/LazyVim/commit/f892ba5cffe8fcac724ad6b801e0824b391fa037))
* **autocmd:** remove query from q-to-quit autocmd ([#473](https://github.com/ueaner/LazyVim/issues/473)) ([b0cef1f](https://github.com/ueaner/LazyVim/commit/b0cef1f506e4bbaa8cfe07990ee49518d8e13f3d))
* **autocmds:** don't auto create dirs for urls. Fixes [#583](https://github.com/ueaner/LazyVim/issues/583) ([7476da7](https://github.com/ueaner/LazyVim/commit/7476da78117b032bc34d0130e6b1f9c7eea77073))
* **autocmds:** dont jump to last loc in gitcommit buffers ([65c70f6](https://github.com/ueaner/LazyVim/commit/65c70f6ad7e386b54d2aa6dbe137c37ee1d3cb88))
* **autocmds:** jump to last loc in buffer ([#1061](https://github.com/ueaner/LazyVim/issues/1061)) ([baa9614](https://github.com/ueaner/LazyVim/commit/baa96140227a3727b2ea2053f37aa2b7253bb45a))
* **autocmds:** restore tabpage on resize ([#1260](https://github.com/ueaner/LazyVim/issues/1260)) ([f9dadc1](https://github.com/ueaner/LazyVim/commit/f9dadc11b39fb0b027473caaab2200b35c9f0c8b))
* **catppuccin:** change nvim-tree integration to neo-tree for catppuccin/nvim plugin ([#1003](https://github.com/ueaner/LazyVim/issues/1003)) ([2f2c7a3](https://github.com/ueaner/LazyVim/commit/2f2c7a32a4115d06c3bb2b12e6d55f163d701bb3))
* **clangd:** update setup from upstream changes ([#1308](https://github.com/ueaner/LazyVim/issues/1308)) ([73dc5a5](https://github.com/ueaner/LazyVim/commit/73dc5a503f1f42fc12869688df1359ffd80da5d1))
* cleanup all Neovim &lt; 0.9.0 code ([9935dc3](https://github.com/ueaner/LazyVim/commit/9935dc3944c4724d7ee7f70b6bc450f8c3b34a08))
* **config:** compat with lazy.nvim ([501474e](https://github.com/ueaner/LazyVim/commit/501474e42166e199e61b4e704b266bd0a9625a65))
* **config:** options cant be disabled with lazyvim config. Fixes [#566](https://github.com/ueaner/LazyVim/issues/566) ([02c5e8d](https://github.com/ueaner/LazyVim/commit/02c5e8d953fff68b832a8f22a83428bd229ddc59))
* **conform:** use `formatters` for both custom and overriding formatters ([6bb0d1b](https://github.com/ueaner/LazyVim/commit/6bb0d1b66ffe6d0a77ad96d0f945113ddcb9fdb3))
* **copilot:** latest copilot-cmp requires passing opts to _on_insert_enter ([#752](https://github.com/ueaner/LazyVim/issues/752)) ([ad229bb](https://github.com/ueaner/LazyVim/commit/ad229bbf42125c23b933575e7540f7302f128d35))
* **copilot:** re-enable copilot confirm with overwrite ([40983a3](https://github.com/ueaner/LazyVim/commit/40983a326952e24512f0eacc5b524337044ed3ff))
* **copilot:** removed special handling of copilot in cmp. no longer needed ([049e323](https://github.com/ueaner/LazyVim/commit/049e323714a56200e220384a2fe618b5bff631d2))
* **copilot:** work-around Neovim bug. Fixes [#656](https://github.com/ueaner/LazyVim/issues/656) ([4379ae8](https://github.com/ueaner/LazyVim/commit/4379ae8ab9aec497e58eeae733a0a87c70289570))
* **core:** set `cond=true` for LazyVim ([df6ac59](https://github.com/ueaner/LazyVim/commit/df6ac591baf8ab2ef40e3ddcaf34ed124f42469f))
* **dap:** added DapInstall and DapUninstall to cmds ([feaeab9](https://github.com/ueaner/LazyVim/commit/feaeab9fcabf005cbf18b846d2ab0129a73837a9))
* **dap:** fix the mason-nvim-dap setting name ([#781](https://github.com/ueaner/LazyVim/issues/781)) ([b4099a6](https://github.com/ueaner/LazyVim/commit/b4099a64775e3e7722ebaf29612df43c46bf4f03))
* **dap:** move launchjs code from java to dap ([f1af34e](https://github.com/ueaner/LazyVim/commit/f1af34e88525cc291b7bacc76d915b642aef192b))
* **dap:** revert loading vscode launch files. Add it to your own config when needed. Fixes [#1503](https://github.com/ueaner/LazyVim/issues/1503) ([36d6a7f](https://github.com/ueaner/LazyVim/commit/36d6a7fe4f4e7d5c9ffceca0496655a889df2ebc))
* **dashboard:** center the LazyVim logo ([#845](https://github.com/ueaner/LazyVim/issues/845)) ([72b8155](https://github.com/ueaner/LazyVim/commit/72b81553f378669b2cbad16662faed2a6b524df6))
* **diagnostics:** deepcopy diagnostic params. Fixes [#621](https://github.com/ueaner/LazyVim/issues/621) ([1caa27b](https://github.com/ueaner/LazyVim/commit/1caa27ba4acb04ebbc64a91de242574790dcf92f))
* disable context commentstring autocmd ([0bff29c](https://github.com/ueaner/LazyVim/commit/0bff29c07a0d5fb4ef36ba4add2b9c4ee243f8a9))
* **docker:** put hadolint in its own spec ([718c5c6](https://github.com/ueaner/LazyVim/commit/718c5c6036f2aff6534501e151dd3e5ff13a42fa))
* **edgy:** corrected filetype for symbols outline ([d5a9c54](https://github.com/ueaner/LazyVim/commit/d5a9c54faf2a41355d4e2e14b050af188a49365a))
* **edgy:** dont edit help buffers in edgy ([ad6f6cf](https://github.com/ueaner/LazyVim/commit/ad6f6cfffde6da9239d92a76f85544a7e2c4f63d))
* **edgy:** dont layout toggleterm floats ([f7b0c85](https://github.com/ueaner/LazyVim/commit/f7b0c853cc9b6bd035a637a85d3979f040e46c6f))
* **edgy:** make noice windows 0.4 height ([30d03ed](https://github.com/ueaner/LazyVim/commit/30d03eda5b42a783fdb2ed294f6ec83d2825d2d0))
* **edgy:** only add symbolsoutline to the sidebar if it is installed. ([ed89d01](https://github.com/ueaner/LazyVim/commit/ed89d01113b7c8495224cb7a88fe5ccb3f001ac5))
* **extras.go:** remove unneeded formatters since gopls handles them ([#1535](https://github.com/ueaner/LazyVim/issues/1535)) ([964dd6c](https://github.com/ueaner/LazyVim/commit/964dd6c4b2135399758c87afed7e1f3c8e30b487))
* fixes [#1207](https://github.com/ueaner/LazyVim/issues/1207) ([#1213](https://github.com/ueaner/LazyVim/issues/1213)) ([2e09051](https://github.com/ueaner/LazyVim/commit/2e0905147269d92d58627303bcae60bbcb3807dd))
* **flash:** depraction warning ([299aae3](https://github.com/ueaner/LazyVim/commit/299aae3545aa7b7a67a6907e089d80cd63938bf6))
* **flash:** don't override `R` in normal mode ([c5759a4](https://github.com/ueaner/LazyVim/commit/c5759a451f8a5635b5c2d19c82636c8b66676a3b))
* **flash:** possible nil for telescope integration ([abfdab3](https://github.com/ueaner/LazyVim/commit/abfdab37ce127268f6410b89022417d3fa90e0ae))
* **format:** allow `custom_format` to return early ([#1531](https://github.com/ueaner/LazyVim/issues/1531)) ([1c878b9](https://github.com/ueaner/LazyVim/commit/1c878b9d06fb116135419d098fe5dfde5304b709))
* **format:** eslint should respect autoformat ([#897](https://github.com/ueaner/LazyVim/issues/897)) ([2ec4da7](https://github.com/ueaner/LazyVim/commit/2ec4da7fa525c2e1a8c3865d590a77c31f5c58e1))
* **format:** ignore vim.b.autoformat when formatting using key bindings. Fixes [#575](https://github.com/ueaner/LazyVim/issues/575) ([bef36bb](https://github.com/ueaner/LazyVim/commit/bef36bb2fd7493828529ed49a071d240602b164d))
* **format:** only do null-ls formatting logic when null-ls is availble. Fixes [#684](https://github.com/ueaner/LazyVim/issues/684) ([eb143eb](https://github.com/ueaner/LazyVim/commit/eb143ebe110995fb208fc480958a55858944c5f9))
* **format:** wrap custom formatter with error handler ([0e5ff5c](https://github.com/ueaner/LazyVim/commit/0e5ff5c0ab6930190122df086db5e3f91d8b38b8))
* **go:** actually set semantic tokens ([#811](https://github.com/ueaner/LazyVim/issues/811)) ([29632c6](https://github.com/ueaner/LazyVim/commit/29632c6b294465e5abc6472fffc866ec1841e37a))
* **go:** extend mason ensure_installed ([b172f47](https://github.com/ueaner/LazyVim/commit/b172f47f278df105bbbf60b5c0e411fda01c1819))
* **go:** make settings configurable for go ([1e1fc3c](https://github.com/ueaner/LazyVim/commit/1e1fc3c6a06fb98f305d8753939c6b871ae26e33))
* **health:** remove deprecated api warning ([#666](https://github.com/ueaner/LazyVim/issues/666)) ([4fbb7a2](https://github.com/ueaner/LazyVim/commit/4fbb7a280310a6ea500509aa73a4f7c7d06f6bea))
* **hipatterns:** default options ([3082436](https://github.com/ueaner/LazyVim/commit/30824369c2c58647df170566766ea1dbda2730cc))
* **hipatterns:** make it work on stable ([33f61b5](https://github.com/ueaner/LazyVim/commit/33f61b58de3519ef568bc9591fb877a71a203a6d))
* **hipatterns:** make sure priority is higher than the one for references ([b027beb](https://github.com/ueaner/LazyVim/commit/b027bebeab30308f26f5cafe1642f3aa0e541ca3))
* **hipatterns:** remove assert. Fixes [#1045](https://github.com/ueaner/LazyVim/issues/1045) ([6d58f1d](https://github.com/ueaner/LazyVim/commit/6d58f1dacf1652ba49ff97631e59fc4ec9ee4faa))
* **hipatterns:** reset hl groups when colorscheme changes ([b7a9259](https://github.com/ueaner/LazyVim/commit/b7a925904ea30d85a96683df9980960ef349eacf))
* **ibl:** use default hl groups ([74786c2](https://github.com/ueaner/LazyVim/commit/74786c21d743db0fabed61b90bf7ecaab16bbf14))
* **icons:** replace obsolete icons ([#441](https://github.com/ueaner/LazyVim/issues/441)) ([cec000d](https://github.com/ueaner/LazyVim/commit/cec000dfd863bd681a5195eb71c0797f5d030062))
* **icons:** updated a dap icon ([6ebf3ab](https://github.com/ueaner/LazyVim/commit/6ebf3ab084361b47796840fb6f7fe00cd05dfeb4))
* **indent-blankline:** don't load indent-blankline for nvim-notify ([a94ef59](https://github.com/ueaner/LazyVim/commit/a94ef5953a6f14731d9aea447e769c280db140ab))
* **indent-blankline:** upgrade ibl config to v3 ([db86635](https://github.com/ueaner/LazyVim/commit/db86635e3276451f795da4f8af64eff94391fe48))
* **indentscope:** dont use indentscope/blankline for lazyterm/toggleterm/notify ([15f5a22](https://github.com/ueaner/LazyVim/commit/15f5a229d9b9fcdfd980050e7fe8dff74313d9fd))
* **java:** don't accumulate on_attach, and make more configurable ([#1388](https://github.com/ueaner/LazyVim/issues/1388)) ([15022f4](https://github.com/ueaner/LazyVim/commit/15022f4892726f9899ce5eb3aed7a19df29f62ef))
* **keymaps:** added c-_ mapped to c-/ to make it work in some terminals ([d31772f](https://github.com/ueaner/LazyVim/commit/d31772f981d41ae84bb4b6e86c28d95f01100a37))
* **keymaps:** better j/k for visual mode ([#902](https://github.com/ueaner/LazyVim/issues/902)) ([e049928](https://github.com/ueaner/LazyVim/commit/e049928b8bb3a385a186617a97c56cfb8f74a6f8))
* **keymaps:** change `v` mode to `x` mode for `save file` ([#1262](https://github.com/ueaner/LazyVim/issues/1262)) ([ec0ddd4](https://github.com/ueaner/LazyVim/commit/ec0ddd481c785833c5caac9c9d22889b9e963883))
* **keymaps:** disable ctrl-hjkl for lazygit. Fixes [#905](https://github.com/ueaner/LazyVim/issues/905) ([ebd002f](https://github.com/ueaner/LazyVim/commit/ebd002f135b02f38654d14ea8c46d831c9054b7e))
* **keymaps:** dont map jk in visual. Use x instead of v. Fixes [#912](https://github.com/ueaner/LazyVim/issues/912) ([d6bb907](https://github.com/ueaner/LazyVim/commit/d6bb907cf042463073540f7334e4271a4d2fb108))
* **keymaps:** remove `c-w` mapping ([952a0cf](https://github.com/ueaner/LazyVim/commit/952a0cfb96e7258dcbe8c9f4d8bdfd978888f17c))
* **keymaps:** remove gw keymap ([23e2b07](https://github.com/ueaner/LazyVim/commit/23e2b073e6fa75dacaa58dc1fe63392af7f54598))
* **keymaps:** remove redundant ':' on lazy keymap ([#977](https://github.com/ueaner/LazyVim/issues/977)) ([e9358d9](https://github.com/ueaner/LazyVim/commit/e9358d977a379e54d73dd29691d60f7a51ed6923))
* **keymaps:** terminal show/hide ([1897617](https://github.com/ueaner/LazyVim/commit/1897617c98807ce9dd8eaa1f495a2d49a6166316))
* **lang_java:** fixes [#1215](https://github.com/ueaner/LazyVim/issues/1215) other two entries of `vim.fs.joinpath` as well that were not changed in [#1213](https://github.com/ueaner/LazyVim/issues/1213) ([#1216](https://github.com/ueaner/LazyVim/issues/1216)) ([9fe89f5](https://github.com/ueaner/LazyVim/commit/9fe89f5f8a5a50438276a4d2f757549ea2496ca0))
* **lang:** indentation in rust lang extra ([#1017](https://github.com/ueaner/LazyVim/issues/1017)) ([c992ebe](https://github.com/ueaner/LazyVim/commit/c992ebec468b2e60f1138fd85055118016c62165))
* **lazygit:** dont use `&lt;esc&gt;<esc>` for normal more for laygit to prevent delays on `<esc>`. Fixes [#567](https://github.com/ueaner/LazyVim/issues/567) ([a9e9204](https://github.com/ueaner/LazyVim/commit/a9e9204daec3355015bbe677068198cf38cd2cf3))
* leap nvim required by flit ([#1046](https://github.com/ueaner/LazyVim/issues/1046)) ([dee8dc3](https://github.com/ueaner/LazyVim/commit/dee8dc318efac8883fe149503ea92924ff4a4de2))
* **lsp-config:** lsp-config error when nvim-cmp not enabled. ([#1095](https://github.com/ueaner/LazyVim/issues/1095)) ([3f68f44](https://github.com/ueaner/LazyVim/commit/3f68f44d725747339933298cdac02589b37ea76c))
* **lsp:** don't install jsonls by default. It's part of the json extra ([fa6cbfc](https://github.com/ueaner/LazyVim/commit/fa6cbfc6020efcd2168ffe09a209037599b91442))
* **lsp:** fixup lsp keymaps ([8ccc109](https://github.com/ueaner/LazyVim/commit/8ccc109e920bcbe041c89f7e022bbfb2dbf4a09b))
* **lsp:** gt -&gt; gT. Fixes [#554](https://github.com/ueaner/LazyVim/issues/554) ([2d8116e](https://github.com/ueaner/LazyVim/commit/2d8116ef674ad4b2a3ba62f590ff32d1c30a2f9c))
* **lsp:** gT =&gt; gy. keymap for goto type definition. Fixes [#554](https://github.com/ueaner/LazyVim/issues/554) ([0cb8974](https://github.com/ueaner/LazyVim/commit/0cb89742216d4c73fa944ab9e2fcd21793ed7a78))
* **lsp:** properly check that diagnostics virtual_text is a table. Fixes [#618](https://github.com/ueaner/LazyVim/issues/618) ([17fe32e](https://github.com/ueaner/LazyVim/commit/17fe32e428bbade6f91770814e8748425bfc01a2))
* **lsp:** resolve keymap capabilities over all buffer clients ([36774c6](https://github.com/ueaner/LazyVim/commit/36774c605848dc3bee8b9e0e4673e684b47bd89c))
* **lsp:** supports_method for checking inlay hint support ([#1195](https://github.com/ueaner/LazyVim/issues/1195)) ([9a05435](https://github.com/ueaner/LazyVim/commit/9a0543531d05a417ba63f3dd710530ba5765aca5))
* **lsp:** update keymaps *after* registering capabilities ([a981682](https://github.com/ueaner/LazyVim/commit/a981682603480e34b23615433e4ebefe07276dc2))
* **lsp:** upstream inlay_hint rename ([089606b](https://github.com/ueaner/LazyVim/commit/089606b48dc6bb94bac36d1c30e50899a8d6f81f))
* **lualine:** dont load copilot when not available. Fixes [#872](https://github.com/ueaner/LazyVim/issues/872) ([5ed3250](https://github.com/ueaner/LazyVim/commit/5ed3250f2475f498cd14643f4788ee95108f2ada))
* **luasnip:** use `echo` instead of `echo -e` for build warning ([88238e2](https://github.com/ueaner/LazyVim/commit/88238e2109e8340fae1424f693149ff2c334ae1c))
* make some extra deps optional ([183fd89](https://github.com/ueaner/LazyVim/commit/183fd89d76b24c5e293d368a59c5db3a7c7f85d5))
* **mason:** add MasonUpdate to build ([b4b27e8](https://github.com/ueaner/LazyVim/commit/b4b27e867c4d2ba2bddd1df4c144ccdf1b4bfabc))
* **mason:** exclude filetype mason in indent-blankline.nvim ([#701](https://github.com/ueaner/LazyVim/issues/701)) ([ea48588](https://github.com/ueaner/LazyVim/commit/ea4858874b983e4b3a8a7078828d98533e386035))
* **mason:** removed flake8. You can add it back in your own configs if you need it or add ruff_lsp ([381ee0a](https://github.com/ueaner/LazyVim/commit/381ee0a9fc536a4e1ed9ad3e089f10129f0d50a0))
* **mini.comment:** better lua pattern for tags. Fixes [#1413](https://github.com/ueaner/LazyVim/issues/1413) ([7c79cfe](https://github.com/ueaner/LazyVim/commit/7c79cfe07314245decd73ec67e7247bba22abaa9))
* **mini.comment:** removed dirty upvalues hack for mini.comments. no longer needed ([b75ed59](https://github.com/ueaner/LazyVim/commit/b75ed594a932e6e01d8c1ee5b23215221164d494))
* **mini.files:** changed some window widths ([d1eb9c8](https://github.com/ueaner/LazyVim/commit/d1eb9c89d3d2959d6d106b0c11c12b21fb3bbf50))
* **mini:** lazy now supports mini plugins out of the box. no longer needed to have a custom config ([bd1ba54](https://github.com/ueaner/LazyVim/commit/bd1ba54d1347c1f340db896f25e43c8591365512))
* **neo-tree:** updated some icons to use Nerd Fonts v3. Fixes [#957](https://github.com/ueaner/LazyVim/issues/957) ([0b99c9f](https://github.com/ueaner/LazyVim/commit/0b99c9f788f04d658b4370c8f553542563cd3482))
* **neoconf:** do neoconf setup in lspconfig setup. Fixes [#1070](https://github.com/ueaner/LazyVim/issues/1070) ([9e8ce28](https://github.com/ueaner/LazyVim/commit/9e8ce289d12eb65146be3cb1b3800440e208496d))
* **neotest:** added some additional filetypes to close with q ([1288f0d](https://github.com/ueaner/LazyVim/commit/1288f0d5a5cc5f5279678cc3c3d99abe20a1e052))
* **neotest:** pass opts to neotest ([bf66e71](https://github.com/ueaner/LazyVim/commit/bf66e71adcf0346a3d6edd92a14e0fcd350f5b26))
* **neotest:** properly detect __call. Fixes [#847](https://github.com/ueaner/LazyVim/issues/847) ([0e671ad](https://github.com/ueaner/LazyVim/commit/0e671ad7fabdb3af181feda18951596a83167bc9))
* **neotest:** removed `&lt;leader&gt;tR` in favor of `<leader>tt` ([a866c68](https://github.com/ueaner/LazyVim/commit/a866c6801df058c6bef613acfb2eeea9cedb41b1))
* **neotest:** support neotest adapaters that use `setup()` for custom setup ([2a3bac7](https://github.com/ueaner/LazyVim/commit/2a3bac769045abac76395fcabb36b17b68bc42fc))
* **nvim-lint:** dont use default configured linters from nvim-lint ([ff5f588](https://github.com/ueaner/LazyVim/commit/ff5f5886db321679e3fdc5dbb82b12daf6075510))
* **nvim-lint:** use `linters` for both custom and overriding linters ([31d9136](https://github.com/ueaner/LazyVim/commit/31d913697bc9b731bc941362021ce06617f627d3))
* **persistence:** dont add rtp to session ([99785ce](https://github.com/ueaner/LazyVim/commit/99785ce36b523cca46c1f2fd6edeaf1189bcd934))
* **project:** load on VeryLazy otherwise projects wont be loaded when opening Telescope ([5264909](https://github.com/ueaner/LazyVim/commit/5264909b542da1c6215e042c62903bb491a2c1eb))
* **python:** disable ruff hover correctly ([#1365](https://github.com/ueaner/LazyVim/issues/1365)) ([451bde5](https://github.com/ueaner/LazyVim/commit/451bde5b41ec410afbb2b5e75e339a3fc44c5587))
* **python:** make venv-selector `dap_enabled` conditional on `nvim-dap-python` ([#1529](https://github.com/ueaner/LazyVim/issues/1529)) ([7821c0e](https://github.com/ueaner/LazyVim/commit/7821c0e85199205af98ceedfb2c4990c96900e46))
* **python:** use venv for DAP Python ([#1457](https://github.com/ueaner/LazyVim/issues/1457)) ([ea930e3](https://github.com/ueaner/LazyVim/commit/ea930e35457df4a367b537c472af8d5c6e8ae7eb))
* **qf:** better error message. Fixes [#892](https://github.com/ueaner/LazyVim/issues/892) ([448d502](https://github.com/ueaner/LazyVim/commit/448d502947a3e8a81a2ed1f117f72f2e5361082f))
* remove debug notify ([#808](https://github.com/ueaner/LazyVim/issues/808)) ([9cfe88c](https://github.com/ueaner/LazyVim/commit/9cfe88c7ba1ff2b36a0cc32e96d5be1d6e5ee833))
* remove deprecated leap/flit code checks ([6b05ed7](https://github.com/ueaner/LazyVim/commit/6b05ed7dcd729322e2e5b6752655a9491cd17f86))
* remove nvim-colorizer.lua It actually wasn't even enabled and I'll add hipatterns with optional tailwind support soon ([9c7821e](https://github.com/ueaner/LazyVim/commit/9c7821e681e264905d7f764aeddda78162a9d867))
* remove unintentional `&lt;lt&gt;nop>` mapping ([#651](https://github.com/ueaner/LazyVim/issues/651)) ([14e708a](https://github.com/ueaner/LazyVim/commit/14e708a24642cf3926b9b74743c192c3b5c63f3e))
* **rust:** remove rust-tools dep from lspconfig ([39627ca](https://github.com/ueaner/LazyVim/commit/39627cab42cdaaab3d70c3013ce82b9caae7c623))
* **spectre:** make spectre behave with regards to swap files ([bb4a7fe](https://github.com/ueaner/LazyVim/commit/bb4a7fe410d8aaf9507cd2a8ed7c7680852cf297))
* **spectre:** use new url by default ([7b9145c](https://github.com/ueaner/LazyVim/commit/7b9145c12d15a81e40a721974a9a68994ccd8855))
* **tailwind:** nil check on filetypes_exclude. See [#816](https://github.com/ueaner/LazyVim/issues/816) ([4b36795](https://github.com/ueaner/LazyVim/commit/4b367952f6214e1ae213eba2ae706df691ff57fa))
* **telescope:** add enums and consts to search symbols ([#1512](https://github.com/ueaner/LazyVim/issues/1512)) ([b220e54](https://github.com/ueaner/LazyVim/commit/b220e541594a0ef556d1515649cd99d45fe94058))
* **telescope:** consistent keymap description. Fixes [#600](https://github.com/ueaner/LazyVim/issues/600) ([df9547f](https://github.com/ueaner/LazyVim/commit/df9547f43223fd89ccc7c1fa5088623ca3c2cfd4))
* **telescope:** keep current prompt when switching to hidden/no_ignore ([78354a1](https://github.com/ueaner/LazyVim/commit/78354a1e5e88c68a9d99b72af5a0844befee419b))
* **telescope:** replace anonymous functions in mappings by named functions ([#1294](https://github.com/ueaner/LazyVim/issues/1294)) ([13bf797](https://github.com/ueaner/LazyVim/commit/13bf7977a4bae39a38ef6a3fad6303366c8b4bea))
* **telescope:** typo ([017582c](https://github.com/ueaner/LazyVim/commit/017582c05a2d87c73cfe794dd2e296cc0caf86cd))
* **telescope:** typo ([a94f7af](https://github.com/ueaner/LazyVim/commit/a94f7afdebc56338b5552de11561646d8ef4b5be))
* **telescope:** use last-known telescope commit to work on Neovim 0.8.0 when running in Neovim 0.8.0 ([877e63c](https://github.com/ueaner/LazyVim/commit/877e63ca8ee5efe1420744f7a843dd4fd0215764))
* **terraform:** configure commentstring ([#1171](https://github.com/ueaner/LazyVim/issues/1171)) ([e5f53ee](https://github.com/ueaner/LazyVim/commit/e5f53ee1931fdc8c0f0d3150cbb5742dcb8ff477))
* **treesitter:** de-duplicate langs in endure_installed. Fixes [#628](https://github.com/ueaner/LazyVim/issues/628) ([1d2c97c](https://github.com/ueaner/LazyVim/commit/1d2c97cbda099c76ee132ee5019a3f80fd88f8ed))
* trigger ci ([755419f](https://github.com/ueaner/LazyVim/commit/755419f39cf0ca0407a3a6a16dad35942c653572))
* **typescript:** removed `typescript.nvim` since it's deprecated ([aab365a](https://github.com/ueaner/LazyVim/commit/aab365a9f8b6405c6c5a938cb4745e9b770f2261))
* **typescript:** use new lsp keymaps config for typescript ([4009620](https://github.com/ueaner/LazyVim/commit/4009620651c7422b3ce11484916865073e95574d))
* **util:** fixed line number toggling. Closes [#1173](https://github.com/ueaner/LazyVim/issues/1173) ([df08188](https://github.com/ueaner/LazyVim/commit/df0818880e66086f10982827ea11332b46c3b74f))
* **util:** use spec to check if a plugin is enabled ([bcff5a1](https://github.com/ueaner/LazyVim/commit/bcff5a19379e32a85049500de420aa24b271fb72))
* **vscode:** added ts-context-commentstring ([e975f02](https://github.com/ueaner/LazyVim/commit/e975f021eaf1eb33fb8793c8e922ab11a8b682f2))
* **vscode:** only remap keybinds when running in vscode ([7c9abd7](https://github.com/ueaner/LazyVim/commit/7c9abd7463a27b7a7fd8a0c7e59653a7602613b6))
* **vscode:** properly cleanup disabled deps ([eba510e](https://github.com/ueaner/LazyVim/commit/eba510ec6934a22f3654a83ed89216bb96e7374c))
* **vscode:** support older Neovim versions. Fixes [#798](https://github.com/ueaner/LazyVim/issues/798) ([3dcc074](https://github.com/ueaner/LazyVim/commit/3dcc074693c3560982d6e500aa073140a9c5c0ed))
* **which-key:** don't load which-key as a noice dep ([f54d95d](https://github.com/ueaner/LazyVim/commit/f54d95d96511e1e8a575573b937a99338f178639))
* **yamlls:** work-around for yaml formatting on Neovim &lt; 0.10. Fixes [#1435](https://github.com/ueaner/LazyVim/issues/1435) ([7f5051e](https://github.com/ueaner/LazyVim/commit/7f5051ef72cfe66eb50ddb7c973714aa8aea04ec))
* **yaml:** yaml validate and enable line folding ([#1251](https://github.com/ueaner/LazyVim/issues/1251)) ([a62a594](https://github.com/ueaner/LazyVim/commit/a62a5942deb281b9edce3673e656854805297199))
* **yaml:** yaml: Fix TypeError undefined length ([#1229](https://github.com/ueaner/LazyVim/issues/1229)) ([d7ca822](https://github.com/ueaner/LazyVim/commit/d7ca822d41bc65e31dc1019a64d5d3518c8e2470))
* **yanky:** don't override c-p insert mode telescope mapping. Fixes [#1007](https://github.com/ueaner/LazyVim/issues/1007) ([8b1e797](https://github.com/ueaner/LazyVim/commit/8b1e7976a004d7e0cbaec37546d2889ddab48bbb))
* **yanky:** use leader-p for telescope integration ([e83d2c8](https://github.com/ueaner/LazyVim/commit/e83d2c814f336470fa212cef2f03ceb8ac173012))


### Performance Improvements

* **comment:** removed nvim-ts-context-commentstring, since mini.comment now handles that internally ([44df743](https://github.com/ueaner/LazyVim/commit/44df7434d4320d27672cca937e594efbf1e021ba))
* dont't load schemastore as an lspconfig dep ([9d17c43](https://github.com/ueaner/LazyVim/commit/9d17c4308713e8db7ec03871ba62ff80a3bfb79c))
* **eslint:** only run EslintFixAll for the current buffer when there are diagnostics from eslint ([b227d97](https://github.com/ueaner/LazyVim/commit/b227d9727a7ae1f0ad48504d613fb099dc9c461b))
* **illuminate:** on large files &gt;2000 lines, enable lsp references only ([08422bf](https://github.com/ueaner/LazyVim/commit/08422bf559cb74a2e673e60d551269cbcb2e18df))
* **treesitter:** better way of loading treesitter-textobjects ([09fafb9](https://github.com/ueaner/LazyVim/commit/09fafb946aefd8434f479656c22b90d9bc63c684))


### Documentation

* LazyVim now requires Neovim &gt;= 0.9.0 ([bfe0422](https://github.com/ueaner/LazyVim/commit/bfe04222fe5585179f03197b01a6f6ed711d4421))


### Code Refactoring

* **treesitter:** rename help to vimdoc ([#521](https://github.com/ueaner/LazyVim/issues/521)) ([078250a](https://github.com/ueaner/LazyVim/commit/078250a114b45785743fcfe0482c7667f304f92c))
